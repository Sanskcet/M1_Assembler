   ...
   while(NOT_EOF){
    ...
    if(strcmp(inst,"EOF")){
        ...
        if(k==0){
            ...
            strcpy(Hex_Code_1 , process_Hex_Code_1(Operands[0],Operands[1],Operands[2]));
            strcpy(Hex_Code_2 , process_Hex_Code_2(Operands[0],Operands[1],Operands[2]));
